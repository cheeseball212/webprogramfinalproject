<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AboutUs.aspx.vb" Inherits="_Default" %>
    ...
    <!-- Table for pics & contact info -->
      <div>
        <table style="text-align:center" align="center">
            <tbody><tr>
                <td>
                    <img style="height:100%; width:75%" alt="Justin Gochenaur" class="auto-style1" src="pics/justin.png"/>
                </td>
                <td>

                    <img style="height:100%; width:75%" alt="Cameron Weiler" class="auto-style2" src="pics/cameron.png"/>

                </td>
                <td>

                    <img style="height:100%; width:75%" alt="Trey Recher" class="auto-style3" src="pics/trey.png"/>
